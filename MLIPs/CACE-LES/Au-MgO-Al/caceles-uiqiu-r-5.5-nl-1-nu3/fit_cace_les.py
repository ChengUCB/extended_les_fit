...
cutoff = 5.5
train_xyz = '/global/scratch/users/dongjinkim/potential_training/CACE-LES-dipole/data-sets/train-Au-MgO-Al.xyz'
avg_E0= {8: -18599.43617104475, 12: -8721.75974245582, 13: -9877.676428588728, 79: -688.8680063349827} # avg
...
task.save_model('aumgo-model.pth')
cace_nnp.to(device)
...
task.save_model('aumgo-model-2.pth')
cace_nnp.to(device)
...
task.save_model('aumgo-model-3.pth')
...
task.save_model('aumgo-model-4.pth')
