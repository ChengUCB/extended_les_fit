...
cutoff = 5.29 
train_xyz = '/global/scratch/users/dongjinkim/potential_training/CACE-LES-dipole/data-sets/train_NaCl.xyz'
avg_E0={11: -4417.07609365649, 17: -12516.880649933015} # avg
...
task.save_model('nacl-model.pth')
cace_nnp.to(device)
...
task.save_model('nacl-model-2.pth')
cace_nnp.to(device)
...
task.save_model('nacl-model-3.pth')
...
task.save_model('nacl-model-4.pth')
