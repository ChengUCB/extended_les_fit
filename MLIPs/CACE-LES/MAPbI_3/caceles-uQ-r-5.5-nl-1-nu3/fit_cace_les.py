...
collection = cace.tasks.get_dataset_from_xyz(train_path='../MaPbI3.xyz',
                                 valid_fraction=0.1,
                                 seed=1,
                                 cutoff=cutoff,
...
task.save_model('mapi-model.pth')
cace_nnp.to(device)
...
task.save_model('mapi-model-2.pth')
cace_nnp.to(device)
...
task.save_model('mapi-model-3.pth')
...
task.save_model('mapi-model-4.pth')
