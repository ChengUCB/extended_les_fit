...
cutoff = 5.5
train_xyz = '/global/scratch/users/dongjinkim/potential_training/CACE-LES-dipole/data-sets/train_MAPbI3.xyz'
avg_E0= {1: -28.854691484546134, 6: -4.8091152474243515, 7: -4.809115247424349, 53: -14.427345742273191, 82: -4.809115247424349}# avg

logging.info("reading data")
collection = cace.tasks.get_dataset_from_xyz(train_path=train_xyz,
                                 valid_fraction=0.05,
                                 seed=1,
                                 cutoff=cutoff,
                                 data_key={'energy': 'energy', 'forces':'forces'}, 
                                 atomic_energies=avg_E0
                                 )
batch_size = 4 
...
multipoles = TensorReadout(max_l=2,
                           l0_key='kappas',
                           l1_key='dipoles',
                           l2_key='alphas',
                           l0_output_scale=0.1,
...
#multipoles = TensorReadout(max_l=1,
#                           l0_key='kappas',
#                           l1_key='dipoles',
#                           l0_output_scale=0.1,
#                           l1_output_scale=1.,
#                           )
#iso_alpha = cace.modules.atomwise.Atomwise(n_layers=3,
#                                         per_atom_output_key='alphas',
#                                         n_hidden=[32,16],
#                                         use_batchnorm=False,
#                                         add_linear_nn=True,
#                                         output_scale=1.0,
...
#    output_modules=[multipoles, iso_alpha, les_e, sr_energy, e_add, forces]
)
...
task.save_model('MaPbI3-model.pth')
cace_nnp.to(device)
...
task.save_model('MaPbI3-model-2.pth')
cace_nnp.to(device)
...
task.save_model('MaPbI3-model-3.pth')
...
task.save_model('MaPbI3-model-4.pth')
